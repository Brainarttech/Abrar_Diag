...
<div class="referred-doctor-form">

    <?php
    $form = ActiveForm::begin([
                'id' => 'form',
                'enableAjaxValidation' => true,
                'validationUrl' => ($model->isNewRecord) ? Yii::$app->homeUrl . 'referred-doctor/validate' : Yii::$app->homeUrl . 'referred-doctor/validate?id=' . $model->id . '',
                'options' => [
