...
$this->title = 'Additional Cost Test Items';
...
<div class="item-name-index">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '<h5 class="card-title"><i class="fa fa-th-list"></i> '.Yii::t ( 'app', 'Products' ).' </h5>',
        ...
        'columns' => [
            ...
            [
                ...
                'buttons' => [
                    ...
                    {
                        return '<a href="#"><span class="fa fa-pencil"  onclick="updateRecord('.$model->id.',\'additional-cost-item\',\'Update Item\',event)"></span></a>';
                    } ,
                ]
            ]
        ],
