...
<div class="user-index">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '<h5 class="card-title"><i class="fa fa-th-list"></i> '.Yii::t ( 'app', 'Make Payment' ).' </h5>',
            'before' => '',
			...
			[
                ...
                'buttons' => [
                    'create' => function ($url, $model)
                    {
                        ...
                        return '<a href="make-payment-create?id='.$model->id.'" onclick="addnew(event,this)" class="btn btn-outline-success">Make Payment</a>';
                    },
					'view' => function ($url, $model)
                    {
                        ...
                        //return '<button type="button" class="btn btn-outline-info">View</button>';
                        return '<a href="view-payment?id='.$model->id.'" class="btn btn-outline-info">View</a>';
                    },
                ]
            ] ,
		    // [
