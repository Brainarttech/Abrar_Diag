...
if(\Yii::$app->user->can('item-name/create')){
    $create = Html::a('<i class="fa fa-plus"></i> ' . Yii::t('app', 'Add New Expense Category'), [
        'create'
...
<div class="expense-category-index">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '<h5 class="card-title"><i class="fa fa-th-list"></i> '.Yii::t ( 'app', 'Expense Category List' ).' </h5>',
        ...
        'columns' => [
            ...
            [
                ...
                'buttons' => [
                    ...
                    {
                        return '<a href="#"><span class="fa fa-pencil"  onclick="updateRecord('.$model->id.',\'expense-category\',\'Update Expense Category\',event)"></span></a>';
                    } ,
                ]
            ]
        ],
