...
if (\Yii::$app->user->can('item-name/create')) {
    $create = Html::a('<i class="fa fa-plus"></i> ' . Yii::t('app', 'Add New Brand'), [
                'create'
...
<div class="brand-index">
    ...
    GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '<h5 class="card-title"><i class="fa fa-th-list"></i> ' . Yii::t('app', 'Brand List') . ' </h5>',
            ...
            [
                ...
                'buttons' => [
                    'update' => function ($url, $model) {
                        return '<a href="#"><span class="fa fa-pencil"  onclick="updateRecord(' . $model->id . ',\'brand\',\'Update Brand\',event)"></span></a>';
                    },
                ]
            ]
        ],
