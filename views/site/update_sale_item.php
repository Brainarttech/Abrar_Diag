                ...
                <div class="m-portlet__body m-portlet__body--no-padding">
                    <div class="m-invoice-2">
                        <div class="m-invoice__wrapper">
                            ...
                            <form  class="m-form m-form--fit m-form--label-align-right" action="<?php echo Yii::$app->homeUrl ?>ajax/submit-department-report" id="m_form" novalidate="novalidate">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table" id="tab_optional">
                                                            ...
                                                            <tbody id="optionaltable">
                                                                <?php
                                                                $i = 0;
                                                                print_r($lab_form_field_submit);
                                                                foreach ($lab_form_field_submit as $value) {
                                                                    $i++;
                                                                    ?>
...
foreach ($option_items as $data) {
    $option['id'] = $data['id'];
    $option['text'] = $data['product_name'];
    $option['qty'] = $data['default_quantity'];
    $option_array[] = $option;
    unset($option);
}
