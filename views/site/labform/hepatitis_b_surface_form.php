...
<h4 class="m-portlet__head-text text-center">Hepatitis B Surface Antigen</h4>
...
<div class="form-group m-form__group row">
    <label for="hepatitisbsurface" class="col-3 offset-2 col-form-label">
        Hepatitis "B" Surface Antigen:
    </label>
	<div class="col-3">
    <?php
        if($dataReader[hepatitis_b] === '0'){
            echo '<input class="form-control m-input" type="text" value="Postive" readonly>';
        }
        else if($dataReader[hepatitis_b] === '1'){
