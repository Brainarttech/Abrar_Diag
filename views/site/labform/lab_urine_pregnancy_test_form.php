...
<h4 class="m-portlet__head-text text-center">Pregnancy Test</h4>
...
<div class="form-group m-form__group row">
    <label for="urinepregnancytest" class="col-3 offset-2 col-form-label">
        Urine Pregnancy Test:
    </label>
    <div class="col-3">
    <?php
        if($dataReader[pregnancy_test] === '0'){
            echo '<input class="form-control m-input" type="text" value="Postive" readonly>';
        }
        else if($dataReader[pregnancy_test] === '1'){
