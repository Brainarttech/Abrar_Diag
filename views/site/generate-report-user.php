...
<div class="container">
  <div class="row">
    <div class="col-sm-12">
   <!-- body header div -->
<div class="font-style dept-span-class " style="text-align:center;font-size:15px;margin-top:10px;margin-bottom:5%;"><span style="font-weight:bold;"><?= $item_data->name?></span>
...
Report</span>
  ...
  <span style="font-size:30px; top:-30px !important;"> <?= Html::img(BaseUrl::base().'\images\image3.png' , ['height' => '400px']) ?></span>
 </div>

<!-- content display div -->

<div id="parent" style="height:70%;width:680px;float:left;
...
<table id="child2" border="2px solid black"  class="table table-hover" style="line-height:1.8;font-size:12px;width:100%;text-align:left">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="left" style="padding-left:45px;"><?= ($patient_data->age."/".$patient_data->age_type) ?></td>
    ...
    <tr class="table-primary">
      ...
      <td align="left" style="padding-left:45px;"> <?= \app\helpers\datetime::saleItemDateTime($patient_data->created_on) ?></td>
...
<!-- Footer -->
  ...
  <button class="print-hide" style="background:#b82326;padding:10px 20px;margin-top:10%;float-right;color:white;border:none;border-radius:15px;cursor:pointer;" onclick="print()">Print the Report</button>
      <!-- End of Footer -->
