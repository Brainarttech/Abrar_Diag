                        ...
                        <div class="m-stack__item m-stack__item--middle m-brand__tools">
							...
							<div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-light m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-dark m-aside-header-menu-mobile--submenu-skin-dark "  >
								<ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
									...
									<li class="m-menu__item m-menu__item--submenu m-menu__item--rel">
										<a href="<?php echo $baseUrl.'referred-doctor';?>" class="m-menu__link">
									...
									<li class="m-menu__item  m-menu__item--submenu m-menu__item--rel"  m-menu-submenu-toggle="click" m-menu-link-redirect="1" aria-haspopup="true">
										...
										<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left">
											...
											<ul class="m-menu__subnav">
                                                ...
                                                <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true">
                                                    <a href="<?= $baseUrl?>sales/index?get=complete" class="m-menu__link ">
                                                ...
                                                <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true">
                                                    <a href="<?= $baseUrl?>sales/index?get=partial-refund" class="m-menu__link ">
                                                        <i class="m-menu__link-icon flaticon-graphic-2"></i>
														<span class="m-menu__link-title">
															<span class="m-menu__link-wrap">
																<span class="m-menu__link-text">
                                                ...
                                                <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true">
                                                    <a href="<?= $baseUrl?>sales/index?get=fully-refund" class="m-menu__link ">
                                                        <i class="m-menu__link-icon flaticon-graphic-2"></i>
														<span class="m-menu__link-title">
															<span class="m-menu__link-wrap">
																<span class="m-menu__link-text">
                                                ...
                                                <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true">
                                                    <a href="<?= $baseUrl?>sales/index?get=all-paid" class="m-menu__link ">
                                                ...
                                                <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true">
                                                    <a href="<?= $baseUrl?>sales/index?get=partial-payment" class="m-menu__link ">
                                                        <i class="m-menu__link-icon flaticon-graphic-2"></i>
														<span class="m-menu__link-title">
															<span class="m-menu__link-wrap">
																<span class="m-menu__link-text">
                                                ...
                                                <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true">
                                                    <a href="<?= $baseUrl?>sales/index?get=due-payment" class="m-menu__link ">
                                                        <i class="m-menu__link-icon flaticon-graphic-2"></i>
														<span class="m-menu__link-title">
															<span class="m-menu__link-wrap">
																<span class="m-menu__link-text">
                                                ...
                                                <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true">
                                                    <a href="<?= $baseUrl?>sales/index?get=department-bills" class="m-menu__link ">
                                    ...
                                    <li class="m-menu__item m-menu__item--submenu m-menu__item--rel">
                                        <a href="<?php echo $baseUrl.'expenses';?>" class="m-menu__link">
                ...
                <div class="m-stack__item m-stack__item--middle m-stack__item--left m-header-head" id="m_header_nav">
                    <div class="m-stack m-stack--ver m-stack--desktop">
                        ...
                        <div class="m-stack__item m-stack__item--fluid">
                            ...
                            <div id="m_header_menu" class="m-page-menu m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-light m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-dark m-aside-header-menu-mobile--submenu-skin-dark " style="width: 160%;">
                                <ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
