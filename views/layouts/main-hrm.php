                        ...
                        <div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-light m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-dark m-aside-header-menu-mobile--submenu-skin-dark "  >
                            <ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
                                <li class="m-menu__item m-menu__item--submenu m-menu__item--rel">
                                    <a href="<?php echo $baseUrl . 'hrm/index'; ?>" class="m-menu__link">
                                ...
                                <li class="m-menu__item m-menu__item--submenu m-menu__item--rel">
                                    <a href="<?php echo $baseUrl . 'department/'; ?>" class="m-menu__link">
                                ...
                                <li class="m-menu__item m-menu__item--submenu m-menu__item--rel">
                                    <a href="<?php echo $baseUrl . 'hrm/designation'; ?>" class="m-menu__link">
                                ...
                                <li class="m-menu__item m-menu__item--submenu m-menu__item--rel">
                                    <a href="<?php echo $baseUrl . 'user/index'; ?>" class="m-menu__link">
                                        ...
                                        <div class="m-menu__subnav">
                                            <ul class="m-menu__content">
                                                <li class="m-menu__item">
                                                    ...
                                                    <ul class="m-menu__inner">
                                                        <li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
                                                            <a  href="<?= $baseUrl ?>hrm/leave-type" class="m-menu__link ">
                                                                ...
                                                                <span class="m-menu__link-badge">
                                                                    <span class="m-badge m-badge--success">
                                                                        <?= number_format(\app\models\LeaveType::find()->where(['status' => '1'])->count()); ?>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                        </li>
                                                        <li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
                                                            <a  href="<?= $baseUrl ?>hrm/leave" class="m-menu__link ">
                                                                ...
                                                                <span class="m-menu__link-badge">
                                                                    <span class="m-badge m-badge--success">
                                                                        <?= number_format(\app\models\Leave::find()->where(['status' => '1'])->count()); ?>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                        </li>
                                                ...
                                                <li class="m-menu__item">
                                                    ...
                                                    <ul class="m-menu__inner">
                                                        <li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
                                                            <a  href="<?= $baseUrl ?>hrm/fetch-attendance" class="m-menu__link ">
                                ...
                                <li class="m-menu__item  m-menu__item--submenu m-menu__item--rel"  m-menu-submenu-toggle="click" m-menu-link-redirect="1" aria-haspopup="true">
                                    ...
                                    <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left">
                                        ...
                                        <ul class="m-menu__subnav">
                                            <li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
                                                <a  href="<?php echo $baseUrl . 'hrm/employee-salary-list'; ?>" class="m-menu__link ">
                                            ...
                                            <li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
                                                <a  href="<?php echo $baseUrl . 'hrm/make-payment'; ?>" class="m-menu__link ">
                                                    <i class="m-menu__link-icon flaticon-interface-9"></i>
                                                    <span class="m-menu__link-text">
                                                        MAKE PAYMENT
                                                    </span>
                                ...
                                <li class="m-menu__item  m-menu__item--submenu m-menu__item--rel"  m-menu-submenu-toggle="click" m-menu-link-redirect="1" aria-haspopup="true">
                                    ...
                                    <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left">
                                        ...
                                        <ul class="m-menu__subnav">
                                            ...
                                            <li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
                                                <a  href="<?php echo $baseUrl . 'hrm/'; ?>" class="m-menu__link ">
                                                    <i class="m-menu__link-icon flaticon-interface-9"></i>
                                                    <span class="m-menu__link-text">
                                                        Detail Salary Report
                                                    </span>
                                                </a>
                                            </li>
                                        </ul>
