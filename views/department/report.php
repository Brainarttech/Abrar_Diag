...
<div class="sales-index">
    ...
    <?php  echo $this->render('_sale_item_search', ['model' => $searchModel]); ?>
    ...
    <?= GridView::widget([
       ...
       // 'filterModel' => $searchModel,
        ...
        'panel' => [
            ...
            'heading' => '<h5 class="card-title"><i class="fa fa-th-list"></i> '.Yii::t ( 'app', 'Test Sale Report :  '.$searchModel->created_on).' </h5>',
            'before'=>Html::a ( '<i class="fa fa-repeat"></i> '.Yii::t ( 'app', 'Reset List' ), [
                ...
                ] ).'&nbsp;&nbsp;<a class="btn btn-success"  target=_blank href="'.Yii::$app->homeUrl.'department/print-report?type=print&'.$_SERVER['QUERY_STRING'].'"><i class="fa fa-print">  Print</i></a>',
        ...
        'columns' => [
            ...
            [
                'headerOptions' => ['style' => 'width:10%','class' => 'text-center'],
                'contentOptions' => ['class' => 'text-center'],
                'attribute' =>  'referredReport.doc.name',

            ],
            [
                'headerOptions' => ['style' => 'width:10%','class' => 'text-center'],
                'contentOptions' => ['class' => 'text-center'],
                'attribute' =>  'referredReport.status',
