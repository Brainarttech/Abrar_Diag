                        ...
                        <div class="table-responsive">
                            <table class="table table-sm m-table table-bordered font">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><strong>Referred Reporting Doc.</strong></td>
                                    <td class="text-center"><strong>Referred Report Status</strong></td>
                                ...
                                foreach ($query as $sale)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php
                                            if($sale->sale->referred->status==1){ ?>
                                                Sent
                                            <?php } elseif($sale->sale->referred->status==2) { ?>
                                                Received
