...
<div class="department-index">
    ...
    <p>
        <?php echo  Html::a('Add New Department', ['create'], ['class' => 'btn btn-success pull-right add-new']) ?>
    </p>
    <?php Pjax::begin(); ?>
        ...
        'columns' => [
            ...
            [
                ...
                'buttons' => [
                    ...
                    {
                        return '<a href="#"><span class="fa fa-pencil"  onclick="updateRecord('.$model->id.',\'department\',\'Update Department\',event)"></span></a>';
                    },
                ]
            ],
        ],
