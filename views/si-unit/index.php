...
if (\Yii::$app->user->can('item-name/create')) {
    $create = Html::a('<i class="fa fa-plus"></i> ' . Yii::t('app', 'Add New Unit'), [
                'create'
...
<div class="si-unit-index">
    ...
    GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '<h5 class="card-title"><i class="fa fa-th-list"></i> ' . Yii::t('app', 'Unit List') . ' </h5>',
            ...
            [
                ...
                'buttons' => [
                    'update' => function ($url, $model) {
                        return '<a href="#"><span class="fa fa-pencil"  onclick="updateRecord(' . $model->id . ',\'si-unit\',\'Update Unit\',event)"></span></a>';
                    },
                ]
            ]
        ],
