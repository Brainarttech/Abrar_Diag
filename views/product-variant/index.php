...
if(\Yii::$app->user->can('item-name/create')){
    $create = Html::a('<i class="fa fa-plus"></i> ' . Yii::t('app', 'Add New Product Variant'), [
        'create'
    ], [
...
//            //'updated_on',
            ...
            [
                ...
                'buttons' => [
                    ...
                    {
                        return '<a href="#"><span class="fa fa-pencil"  onclick="updateRecord('.$model->id.',\'product-variant\',\'Update Product Variant\',event)"></span></a>';
                    } ,
                ]
            ]
        ],
