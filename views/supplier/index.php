...
if(\Yii::$app->user->can('item-name/create')){
    $create = Html::a('<i class="fa fa-plus"></i> ' . Yii::t('app', 'Add New Supplier'), [
        'create'
...
<div class="supplier-index">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '<h5 class="card-title"><i class="fa fa-th-list"></i> '.Yii::t ( 'app', 'Supplier List' ).' </h5>',
        ...
        'columns' => [
            ...
            [
                ...
                'buttons' => [
                    ...
                    {
                        return '<a href="#"><span class="fa fa-pencil"  onclick="updateRecord('.$model->id.',\'supplier\',\'Update Supplier\',event)"></span></a>';
                    } ,
                ]
            ]
        ],
