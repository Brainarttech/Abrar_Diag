...
<div class="supplier-form">
    ...
    $form = ActiveForm::begin([
                ...
                'validationUrl' => ($model->isNewRecord) ? Yii::$app->homeUrl . 'supplier/validate' : Yii::$app->homeUrl . 'supplier/validate?id=' . $model->id . '',
                'options' => [
    ...
    <?php /* $form->field($model, 'balance')->textInput(['maxlength' => true]) */ ?>
