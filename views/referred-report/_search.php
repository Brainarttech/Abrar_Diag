            ...
            <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                ...
                <div class="row">
                     ...
                     <div class="col-md-3">
                        ...
                        echo $form->field($model, 'referred_reporting_doc_id')->widget(Select2::classname(), [
                            'data' => ArrayHelper::map(\app\models\ReferredReportingDoc::find()->all(), 'id', 'name'),
                    ...
                    <div class="col-md-2">
                        <?php
                        // Normal select with ActiveForm & model
                        echo $form->field($model, 'sale_item_id')->widget(Select2::classname(), [
                            'data' => ArrayHelper::map(\app\models\ReferredReport::find()->with('saleItem')->all(), 'sale_item_id', 'saleItem.sale.invoice_no'),
                            'theme' => Select2::THEME_BOOTSTRAP,
                            'options' => ['placeholder' => ''],
                            'pluginOptions' => [
                                'allowClear' => true
                    ...
                    <div class="col-md-2">
                        ...
                        <?php
                        echo $form->field($model, 'films_issued')->widget(Select2::classname(), [
                    ...
                    <div class="col-md-2">
                        ...
                        <?php
                        echo $form->field($model, 'report_issued')->widget(Select2::classname(), [
                            'data' => array("1" => "Yes", "0" => "No"),
                            'theme' => Select2::THEME_BOOTSTRAP,
                            'options' => ['placeholder' => ''],
                            'pluginOptions' => [
