                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered m-table m-table--border-primary m-table--head-bg-primary" id="generate_lab_form">
                                ...
                                <tbody>
                                    ...
                                    $get_data = \app\models\LabFormSubmit::find()->where(['sale_item_id' => $sale_item_id])->andWhere(['lab_form_id'=> $model->id])->one();
                                    
                                    $get_data = \app\models\LabFormFieldSubmit::find()->where(['lab_form_submit_id' => $get_data->id])->all();
                                    foreach ($get_data as $data) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $data->name ?></td>
                                            <td>
                                                <input class="form-control m-input" type="text" id="<?= $data->id ?>" name="form_values_id[<?= $data->id ?>]" required value='<?= $data->result ?>'>
                                            </td>
                                            <td><?= $data->unit ?></td>
