...
/* @var $model app\models\DiscountKey */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="discount-key-form">

    <?php
    $form = ActiveForm::begin([
                'id' => 'form',
                'enableAjaxValidation' => true,
                'validationUrl' => ($model->isNewRecord) ? Yii::$app->homeUrl . 'discount-key/validate' : Yii::$app->homeUrl . 'discount-key/validate?id=' . $model->id . '',
                'options' => [
