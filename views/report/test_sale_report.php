...
<div class="sales-index">
    ...
    <?php  echo $this->render('_test_sale_search', ['model' => $searchModel]); ?>
       ...
       // 'filterModel' => $searchModel,
        ...
        'panel' => [
            ...
            'before'=>Html::a ( '<i class="fa fa-repeat"></i> '.Yii::t ( 'app', 'Reset List' ), [
                ...
                ] ).'&nbsp;&nbsp;<a class="btn btn-success"  target=_blank href="'.Yii::$app->homeUrl.'report/test-sale-report?type=print&'.$_SERVER['QUERY_STRING'].'"><i class="fa fa-print">  Print</i></a>',
