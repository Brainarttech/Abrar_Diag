                        ...
                        <div class="col-xl-12 order-2 order-xl-1">
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    echo $form->field($model, 'item_category')->widget(Select2::classname(), [
                                ...
                                <div class="col-md-2">
                                    ...
                                    // Normal select with ActiveForm & model
                                    echo $form->field($model, 'referred_id')->widget(Select2::classname(), [
                                        'data' => ArrayHelper::map(\app\models\ReferredDoctor::find()->all(),'id','name'),
                                        'theme' => Select2::THEME_BOOTSTRAP,
                                        'options' => ['placeholder' => ''],
                                        'pluginOptions' => [
                                            'allowClear' => true
...
HTML;
                                ...
                                <div class="col-md-2">
                                    <?php
                                        ...
                                        // Normal select with ActiveForm & model
                                        echo $form->field($model, 'discount_reason')->widget(Select2::classname(), [
                                            'data' => ArrayHelper::map(\app\models\DiscountKey::find()->all(),'id','key_name'),
                                            'theme' => Select2::THEME_BOOTSTRAP,
                                            'options' => ['placeholder' => ''],
                                            'pluginOptions' => [
                                                'allowClear' => true
                                ...
                                <div class="col-md-2">
                                    <?php
                                            ...
                                            echo $form->field($model, 'payment_method')->widget(Select2::classname(), [
                                                'data' => ArrayHelper::map(\app\models\Mop::find()->all(),'id','name'),
                                                'theme' => Select2::THEME_BOOTSTRAP,
                                                'options' => ['placeholder' => ''],
                                                'pluginOptions' => [
                                                    'allowClear' => true
