...
//  die();
 ...
 foreach ($sales as $sale) {
    ...
    // {
    //     //echo $payment->reference_no;

    //      echo "payment".$payment->amount;
    //      echo "<br>";

    //       $paymentReference=substr($payment->reference_no,0,7);
    //       if($paymentReference=="ADC/PAY")
    //       {
    //             $count++;
...
<html>
    ...
    <page size="A4" layout="portrait">
        <div class="container">
            ...
            <hr>
            <hr>
            <div class="text-center"><strong>Cash Sale Report : <?php if (isset($_GET['SalesSearch']['created_on'])) {
...
?>
                                ...
                                <hr>
            <hr>
            <div class="text-center"><strong>Credit Card Sale Report : <?php if (isset($_GET['SalesSearch']['created_on'])) {
    echo $_GET['SalesSearch']['created_on'];
} else {
    echo $searchModel->created_on;
} ?> </strong></div>
...
?>
                               ...
                               <!------------------- jazz cash sale report ----------------->
                                ...
                                <hr>
                                <hr>
                                <div class="text-center"><strong>Jazz Cash Sale Report: <?php if (isset($_GET['SalesSearch']['created_on'])) {
    echo $_GET['SalesSearch']['created_on'];
} else {
    echo $searchModel->created_on;
} ?> </strong></div>
...
?>
                ...
                <!------------------- easy paisa sale report staet ----------------->
                                 ...
                                 <hr>
                                <hr>
                                <div class="text-center"><strong>Easy Paisa Sale Report: <?php if (isset($_GET['SalesSearch']['created_on'])) {
    echo $_GET['SalesSearch']['created_on'];
} else {
    echo $searchModel->created_on;
} ?> </strong></div>
...
?>
                                ...
                                <hr>
                                <hr>
                                <div class="text-center"><strong>Received Cash Pending Payments: <?php if (isset($_GET['SalesSearch']['created_on'])) {
    echo $_GET['SalesSearch']['created_on'];
} else {
    echo $searchModel->created_on;
} ?> </strong></div>
...
?>
                                ...
                                <hr>
                                <hr>
                                <div class="text-center"><strong>Received Credit Card Pending Payments: <?php if (isset($_GET['SalesSearch']['created_on'])) {
    echo $_GET['SalesSearch']['created_on'];
} else {
    echo $searchModel->created_on;
} ?> </strong></div>
...
?>
                                ...
                                <hr>
                                <hr>
                                <div class="text-center"><strong>Expense: <?php if (isset($_GET['SalesSearch']['created_on'])) {
    echo $_GET['SalesSearch']['created_on'];
} else {
    echo $searchModel->created_on;
} ?> </strong></div>
