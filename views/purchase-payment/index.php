...
$this->title = 'Purchase Payments';
$this->params['breadcrumbs'][] = $this->title;
$create = '';

if (\Yii::$app->user->can('item-name/create')) {
    $create = Html::a('<i class="fa fa-plus"></i> ' . Yii::t('app', 'Add New Payment'), [
                'create'
...
?>
<div class="purchase-payment-index">
    ...
    GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '<h5 class="card-title"><i class="fa fa-th-list"></i> ' . Yii::t('app', 'Payment List') . ' </h5>',
