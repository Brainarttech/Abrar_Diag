...
<div class="inventory-form">
    <div class="row">
        <div class="col-md-6">
            ...
            <?= $form->field($model, 'product_id')->dropDownList(ArrayHelper::map(\app\models\Product::find()->all(), 'id', 'name'), ['prompt' => 'Select Product']) ?>
            ...
            <?= $form->field($model, 'purchase_id')->dropDownList(ArrayHelper::map(\app\models\Purchase::find()->all(), 'id', 'invoice_number'), ['prompt' => 'Select Invoice Number']) ?>
