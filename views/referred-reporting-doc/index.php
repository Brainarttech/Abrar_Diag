...
$this->title = 'Referred Reporting Doctors';
$this->params['breadcrumbs'][] = $this->title;
$create = '';

if(\Yii::$app->user->can('item-name/create')){
    $create = Html::a('<i class="fa fa-plus"></i> ' . Yii::t('app', 'Add New Doctor'), [
        'create'
...
?>
<div class="referred-reporting-doc-index">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '<h5 class="card-title"><i class="fa fa-th-list"></i> '.Yii::t ( 'app', 'Doctor List' ).' </h5>',
        ...
        'columns' => [
            ...
            [
                ...
                'buttons' => [
                    ...
                    {
                        return '<a href="#"><span class="fa fa-pencil"  onclick="updateRecord('.$model->id.',\'referred-reporting-doc\',\'Update Doctor\',event)"></span></a>';
                    } ,
                ]
            ]
        ],
