...
<div class="sales-index">
    <?php  echo $this->render('_tests_sale_search', ['model' => $searchModel]); ?>
    <?php
    ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-right">
                                <div class="dt-buttons btn-group">
                                    <a href="<?= Yii::$app->homeUrl?>sales/tests-sale-report?<?= $_SERVER['QUERY_STRING'];  ?>&print=true" class="btn btn-success buttons-print" tabindex="0" aria-controls="m_table_1"><span>Print</span></a>
                                </div>
                            </div>
                        </div>
                        <br>
