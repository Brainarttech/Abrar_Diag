...
if (isset($_GET['day']) && !empty($_GET['day']))
{
    ...
    $sales = \app\models\Sales::find()
        ...
        ->innerJoinWith(['saleitems.item.category'])
...
<html>
<head>
    <title>Detail Sale Report : <?= $myFormatForView?> </title>
...
<page size="A4" layout="portrait">
    <div class="container">
        ...
        <hr>
        <hr>
        <div class="text-center"><strong>Detail Sale Report : <?= $myFormatForView ?> </strong></div>
        <hr>
        <hr>
        <br>
