            ...
            defaultShowErrors: function() {
                ...
                $.each(this.errorList, function(index, value) {
                    ...
                    if (bsMajorVer === 3 && bsMinorVer >= 3) {
                        ...
                        $(value.element).removeClass(_this.settings.validClass).addClass(_this.settings.errorClass).tooltip('dispose').tooltip(_this.applyTooltipOptions(value.element, value.message)).tooltip('show');
                    }
                ...
                $.each(_this.validElements(), function(index, value) {
                    $(value).removeClass(_this.settings.errorClass).addClass(_this.settings.validClass).tooltip(bsMajorVer === 4 ? 'dispose' : 'dispose');
